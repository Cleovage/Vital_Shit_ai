...
fun CircadianClockDial(
    ...
    Spacer(
        modifier = modifier
            ...
            .drawWithCache {
                val sleepBackingPaint = androidx.compose.ui.graphics.Paint().asFrameworkPaint().apply {
                    isAntiAlias = true
                ...
                val sleepForegroundBrush = Brush.sweepGradient(
                ...
                val glowPaint = androidx.compose.ui.graphics.Paint().asFrameworkPaint().apply {
                    isAntiAlias = true
